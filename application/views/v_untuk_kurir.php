                      ...
                      <tbody>
                        <tr>
                          <td class="product-name">
                            <h2 class="h5 text-black">Jadwal Beras</h2>
                          </td>
						  <td>
                            RM BTS
                          </td>
		...
		<footer class="footer-section">
			<div class="container relative">
				...
				<div class="row g-5 mb-5">
					<div class="col-lg-4">
						<div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo" style="color: #28a745;">TimelyGoodies<span>.</span></a></div>
