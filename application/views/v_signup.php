...
<!--<br>-->
<!--<button name="submit_button">Signup</button>-->
...
<main class="form-signin w-100 m-auto">
  ...
  <form target="dummyframe">
    ...
    <div class="form-floating">
      <input name="username_input" type="text" class="form-control" id="floatingInput" placeholder="name">
    ...
    <br>
    <button name="submit_button" class="btn btn-success w-100 py-2" type="submit">Sign Up</button>
